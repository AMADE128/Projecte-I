...
SceneLevel10::SceneLevel10(bool startEnabled) : Module(startEnabled)
{
...
bool SceneLevel10::Start()
{
	...
	bgTexture10 = App->textures->Load("Assets/Sprites/Maps/lv10.1.png");
...
update_status SceneLevel10::Update()
{
...
{
	// Draw everything --------------------------------------
	App->render->Blit(bgTexture10, 0, 0, NULL);
