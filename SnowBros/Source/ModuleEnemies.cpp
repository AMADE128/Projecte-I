...
bool ModuleEnemies::Start()
{
	...
	monkey = App->textures->Load("Assets/Sprites/Enemies/mono.png");
...
void ModuleEnemies::WinCondition() {
	...
	if (wincondition == 0)
	{
		if (App->modules[5]->IsEnabled() == true)
		{
			...
			win = true;
			App->fade->FadeToBlack((Module*)App->sceneLevel_9, (Module*)App->sceneWon, 90);
		}
	}
}
